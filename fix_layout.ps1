...
<style>
  ...
  .pl-card-img { height: 170px; display: flex; align-items: center; justify-content: center; margin-bottom: 15px; }
  .pl-card-img img { max-height: 100%; max-width: 100%; object-fit: contain; }
  .pl-card-title { font-size: 0.9rem; font-weight: 600; color: #333; text-decoration: none; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; margin-bottom: 10px; }
  .pl-card-price { font-size: 1.15rem; font-weight: 800; color: #111; margin-bottom: 15px; }
  .pl-card-price strike { font-size: 0.85rem; color: #999; font-weight: 400; margin-left: 5px; }
  .btn-add { background: #00bcd4; color: #fff; border: none; font-weight: 700; font-size: 0.9rem; padding: 10px; border-radius: 6px; width: 100%; transition: 0.3s; margin-top: auto; }
  .btn-add:hover { background: #009eb3; color: #fff; }
  .btn-view-all { background: #222; color: #fff; font-weight: 600; padding: 8px 25px; border-radius: 30px; text-decoration: none; transition: 0.3s; font-size: 0.9rem; display: inline-block; }
...
Set-Content -Path resources/views/frontend/home.blade.php -Encoding UTF8 -Value $html
