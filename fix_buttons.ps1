...
<main class="container-fluid px-3 px-xl-5 pl-main-container py-4">
  ...
  <section class="mb-4" style="background: #fff; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.02);">
    ...
    <div class="text-center">
       <a href="{{ url(''/shop?category='' . $cat->slug) }}" class="btn btn-dark text-white fw-bold px-5 py-2" style="border-radius: 30px; font-size: 1rem; text-decoration: none;">VIEW ALL <i class="bi bi-chevron-right ms-1"></i></a>
    </div>
  </section>
  @endforeach
