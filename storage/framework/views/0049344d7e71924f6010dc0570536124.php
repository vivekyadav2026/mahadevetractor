...
<div id="android-install-banner" class="position-fixed bottom-0 start-0 w-100 bg-white border-top shadow-lg" style="display: none; z-index: 9999; padding: 15px;">
    <div class="d-flex align-items-center gap-3">
        <img src="<?php echo e(asset('images/icons/icon-192x192.png')); ?>" class="rounded shadow-sm" style="width: 40px; height: 40px;">
        <div>
...
<?php /**PATH C:\xampp\htdocs\mahadevetractor\resources\views/frontend/partials/pwa_script.blade.php ENDPATH**/ ?>