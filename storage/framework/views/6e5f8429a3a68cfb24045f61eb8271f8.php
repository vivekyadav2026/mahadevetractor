...
<link rel="stylesheet" href="<?php echo e(asset('css/style.css?v=11')); ?>">
<style>
  ...
  .badge-discount { position: absolute; top: 10px; left: 10px; background: #00bcd4; color: #fff; font-size: 0.7rem; font-weight: 800; padding: 3px 8px; border-radius: 20px; z-index: 2; box-shadow: 0 2px 5px rgba(0,188,212,0.4); }
  .pl-card-img { height: 140px; display: flex; align-items: center; justify-content: center; margin-bottom: 8px; padding: 5px; }
  ...
  .btn-add { background: #f8f9fa; color: #111; border: 1px solid #ddd; font-weight: 700; font-size: 0.85rem; padding: 6px; border-radius: 6px; width: 100%; transition: 0.3s; margin-top: auto; }
  ...
  @media(max-width: 768px) {
      ...
      .pl-card-img { height: 110px; margin-bottom: 6px; }
      .badge-discount { font-size: 0.65rem; padding: 2px 6px; top: 6px; left: 6px; }
      .pl-card-title { font-size: 0.75rem; margin-bottom: 4px; }
      .pl-card-price { font-size: 0.95rem; margin-bottom: 8px; }
      .btn-add { padding: 5px; font-size: 0.75rem; }
  }
</style>
</head>
<body>
...
<main class="container-fluid px-3 px-xl-5 pl-main-container py-4">
  ...
  <section class="pl-hero-custom">
    <div class="pl-hero-text" style="flex: 1; max-width: 45%; padding-right: 20px;">
      ...
      <a href="<?php echo e(url('/shop')); ?>" class="btn btn-add" style="display: inline-block; width: auto; padding: 12px 30px; font-size: 1rem; border-radius: 30px; background: #00bcd4; color: #fff; border:none;">अभी खरीदारी करें <i class="bi bi-arrow-right ms-2"></i></a>
    </div>
      ...
      <div id="homeCarousel" class="carousel slide pl-hero-carousel" data-bs-ride="carousel" data-bs-interval="3500">
        ...
        <div class="carousel-inner h-100">
          <div class="carousel-item active h-100">
            <img src="<?php echo e(asset('images/indian_tractor_1.jpg')); ?>" alt="Indian Decorated Tractor">
          </div>
          <div class="carousel-item h-100">
            <img src="<?php echo e(asset('images/slider_new_1.jpg')); ?>" alt="Modern Custom Tractor">
          </div>
          <div class="carousel-item h-100">
            <img src="<?php echo e(asset('images/slider_new_2.jpg')); ?>" alt="Tractor Audio System">
          </div>
        </div>
    ...
    <div class="row g-3 row-cols-2 row-cols-md-3 row-cols-lg-5 mb-3">
      ...
      <div class="col">
        <div class="pl-product-card">
          ...
          <button class="btn-add" onclick="PL.addToCartById('<?php echo e($product->id); ?>')">ADD TO CART</button>
        </div>
      </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    <div class="text-center mb-4">
       <a href="<?php echo e(url('/shop')); ?>" class="btn btn-dark text-white fw-bold px-5 py-2" style="border-radius: 30px; font-size: 1rem; text-decoration: none;">VIEW ALL</a>
    </div>
  </section>
  ...
  <section class="mb-4" style="background: #fff; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.02);">
    ...
    <div class="text-center">
       <a href="<?php echo e(url('/shop?cat=' . $cat->slug)); ?>" class="btn btn-dark text-white fw-bold px-5 py-2" style="border-radius: 30px; font-size: 1rem; text-decoration: none;">VIEW ALL <i class="bi bi-chevron-right ms-1"></i></a>
    </div>
  </section>
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
